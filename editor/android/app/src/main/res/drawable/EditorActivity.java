...
public class EditorActivity extends AppCompatActivity {
    ...
    private TextView tvEditorSubtitle;
    private View dotModified;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvEditorSubtitle = findViewById(R.id.tv_editor_subtitle);
        dotModified      = findViewById(R.id.dot_modified);
        tvEditorTitle.setText(filename);
        tvEditorSubtitle.setText(projectName);
        ...
        codeEditor.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int st, int b, int c) {
                modified = true;
                updateLineNumbers();
                dotModified.setVisibility(View.VISIBLE);
    ...
    private void buildQuickKeyboard() {
        ...
        getTheme().resolveAttribute(R.attr.colorAccentSecondary, tv, true);
        int accent = tv.data;
        getTheme().resolveAttribute(R.attr.colorSurface2, tv, true);
        int surface2 = tv.data;
        getTheme().resolveAttribute(R.attr.colorAccentLight, tv, true);
        int accentLight = tv.data;
        ...
        for (String key : QUICK_KEYS) {
            ...
            btn.setPaddingRelative(18, 8, 18, 8);
            btn.setBackgroundTintList(android.content.res.ColorStateList.valueOf(surface2));
            btn.setStrokeWidth(0);
            btn.setTextColor(accent);
            btn.setRippleColor(android.content.res.ColorStateList.valueOf(accentLight));
            btn.setElevation(0);
    ...
    private void saveFile() {
        ...
        modified = false;
        dotModified.setVisibility(View.INVISIBLE);
